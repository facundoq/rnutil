...
from .plot import plot_regresion_lineal,plot_regresion_lineal_univariada,plot_regresion_logistica2D,plot_fronteras_keras,plot_loss,plot_loss_accuracy,plot_loss_accuracy_keras
