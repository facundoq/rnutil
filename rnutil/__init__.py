print("redes-neuronales-util: Los archivos de los conjuntos de datos que ofrece este paquete también están disponibles en https://github.com/facundoq/redes-neuronales-util/tree/main/rnutil/data para descargar de forma individual")
...
from .plot import plot_regresion_lineal,plot_regresion_lineal_univariada,plot_regresion_logistica2D